...
def create_lmdb_for_SIDD():
    folder_path = '/data3/mxx/datasets/SIDD/train_imdb/train_lmdb'
    lmdb_path = '/data3/mxx/datasets/SIDD/train_imdb/train_lmdb.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'PNG')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/data3/mxx/datasets/SIDD/train_imdb/train_lmdb_gt'
    lmdb_path = '/data3/mxx/datasets/SIDD/train_imdb/train_lmdb_gt.lmdb'
