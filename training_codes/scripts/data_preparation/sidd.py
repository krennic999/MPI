...
# ------------------------------------------------------------------------
# import sys, os, glob
# sys.path.append('/data3/mxx/ssl_denoise/Ref_codes/NAFNet')
...
def main():
    ...
    opt['input_folder'] = '/data3/mxx/datasets/SIDD/Data/'
    opt['save_folder'] = '/data3/mxx/datasets/SIDD/train_imdb/train_lmdb'
    opt['crop_size'] = 512
    opt['step'] = 384
    opt['thresh_size'] = 0
    opt['keywords'] = '_NOISY'
    ...
    opt['save_folder'] =  '/data3/mxx/datasets/SIDD/train_imdb/train_lmdb_gt'
    opt['keywords'] = '_GT'
    extract_subimages(opt)
