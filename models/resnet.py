...
class ResNet(nn.Module):
    def __init__(self, num_input_channels=3, num_output_channels=3, num_blocks=3, num_channels=64, need_residual=True, act_fun='LeakyReLU', need_sigmoid=True, norm_layer=nn.BatchNorm2d, pad='reflection'):
        '''
